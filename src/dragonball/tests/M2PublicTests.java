...
public class M2PublicTests {
	...
	public void testPlayerListenerInterface() throws Exception {
		assertEquals("PlayerListener should be an Interface", 1537, PlayerListener.class.getModifiers());
	}

	@Test(timeout = 1000)
	public void testWorldListenerInterface() throws Exception {
		assertEquals("WorldListener should be an Interface", 1537, WorldListener.class.getModifiers());
	}

	@Test(timeout = 1000)
	public void testCellListenerInterface() throws Exception {
		assertEquals("CellListener should be an Interface", 1537, CellListener.class.getModifiers());
	}

	@Test(timeout = 1000)
	public void testBattleListenerInterface() throws Exception {
		assertEquals("BattleListener should be an Interface", 1537, BattleListener.class.getModifiers());
	}

	@Test(timeout = 1000)
	public void testGameListenerInterface() throws Exception {
		assertEquals("GameListener should be an Interface", 1537, GameListener.class.getModifiers());
	}
	...
	public void testGameClassInterfaces() throws Exception {
		...
		assertTrue("Game class should implement PlayerListener interface.", playerListenerExists);
		assertTrue("Game class should implement WorldListener interface.", wordlListenerExists);
		assertTrue("Game class should implement BattleListener interface.", battleListenerExists);
	}
	...
	public void testWorldClassInterfaces() throws Exception {
		...
		assertTrue("World class should implement CellListener interface.", cellListenerExists);
	}
	...
	public void testPlayerListenerInterfaceMethods() throws Exception {
		...
		try {
			...
			assertTrue("PlayerListener interface should have \"onDragonCalled\" method",
					containsMethodName(methods, "onDragonCalled"));
			assertTrue("PlayerListener interface should have \"onWishChosen\" method",
					containsMethodName(methods, "onWishChosen"));
		...
		try {
			...
			assertTrue("incorrect return type for \"onWishChosen\" method in PlayerListener interface.",
					m.getReturnType().equals(Void.TYPE));
	...
	public void testWorldListenerInterfaceMethods() throws Exception {
		...
		assertTrue("WorldListener interface should have \"onFoeEncountered\" method",
				containsMethodName(methods, "onFoeEncountered"));
		assertTrue("WorldListener interface should have \"onCollectibleFound\" method",
				containsMethodName(methods, "onCollectibleFound"));
		Method m;
		try {
		...
		try {
			...
			assertTrue("incorrect return type for \"onCollectibleFound\" method in WorldListener interface.",
					m.getReturnType().equals(Void.TYPE));
	...
	public void testCellListenerInterfaceMethods() throws Exception {
		...
		assertTrue("CellListener interface should have \"onFoeEncountered\" method",
				containsMethodName(methods, "onFoeEncountered"));
		assertTrue("CellListener interface should have \"onCollectibleFound\" method",
				containsMethodName(methods, "onCollectibleFound"));
		Method m;
		try {
		...
		try {
			...
			assertTrue("incorrect return type for \"onCollectibleFound\" method in CellListener interface.",
					m.getReturnType().equals(Void.TYPE));
	...
	@Test(timeout = 1000)
	public void testBattleListenerInterfaceMethods() throws Exception, SecurityException {

		Method[] methods = BattleListener.class.getDeclaredMethods();
		assertTrue("BattleListener interface should have \"onBattleEvent\" method",
				containsMethodName(methods, "onBattleEvent"));
		Method m;
		try {
	...
	public void testGameListenerInterfaceMethods() throws Exception {
		...
		assertTrue("GameListener interface should have \"onDragonCalled\" method",
				containsMethodName(methods, "onDragonCalled"));
		assertTrue("GameListener interface should have \"onCollectibleFound\" method",
				containsMethodName(methods, "onCollectibleFound"));
		assertTrue("GameListener interface should have \"onBattleEvent\" method",
				containsMethodName(methods, "onBattleEvent"));
		Method m;
		try {
	...
	public void testGameClassInstanceVariables() throws Exception {
		...
		assertEquals("\"state\" instance variable in class Game should be of type GameState", f.getType(),
				GameState.class);
	}

	@Test(timeout = 1000)
	public void testGameClassVariablesAccessibility() throws Exception, NoSuchFieldException, SecurityException {
		Field f = Game.class.getDeclaredField("state");
		assertEquals("\"state\" instance variable in class Game should not be accessed outside that class", 2,
				f.getModifiers());
	}
	...
	public void testGameClassREADVariables() throws Exception {
		...
		assertTrue("The \"state\" instance variable in class Game is a READ variable.",
	...
	public void testBattleClassInstanceVariables() throws Exception {
		...
		assertEquals("\"meBlocking\" instance variable in class Battle should be of type boolean", f.getType(),
				boolean.class);
		...
		assertEquals("\"foeBlocking\" instance variable in class Battle should be of type boolean", f.getType(),
				boolean.class);
	}

	@Test(timeout = 1000)
	public void testBattleClassVariablesAccessibility() throws Exception {
		Field f = Battle.class.getDeclaredField("meBlocking");
		assertEquals("\"meBlocking\" instance variable in class Battle should not be accessed outside that class", 2,
				f.getModifiers());

		f = Battle.class.getDeclaredField("foeBlocking");
		assertEquals("\"foeBlocking\" instance variable in class Battle should not be accessed outside that class", 2,
				f.getModifiers());
	}
	...
	public void testPlayerClassMethods() throws Exception {
		...
		assertTrue("Player class should have \"getMaxFighterLevel\" method",
				containsMethodName(methods, "getMaxFighterLevel"));
		...
		try {
			m = Player.class.getDeclaredMethod("assignAttack", PlayableFighter.class, SuperAttack.class,
					SuperAttack.class);
		...
		try {
			m = Player.class.getDeclaredMethod("assignAttack", PlayableFighter.class, UltimateAttack.class,
					UltimateAttack.class);
	...
	public void testBattleEventClassInstanceVariables() throws Exception {
		...
		assertEquals("\"winner\" instance variable in class BattleEvent should be of type BattleOpponent", f.getType(),
				BattleOpponent.class);
		...
		assertEquals("\"attack\" instance variable in class BattleEvent should be of type Attack", f.getType(),
				Attack.class);
	...
	public void testBattleEventClassVariablesAccessibility() throws Exception {
		...
		assertEquals("\"type\" instance variable in class BattleEvent should not be accessed outside that class", 2,
				f.getModifiers());
		...
		f = BattleEvent.class.getDeclaredField("winner");
		assertEquals("\"winner\" instance variable in class BattleEvent should not be accessed outside that class", 2,
				f.getModifiers());

		f = BattleEvent.class.getDeclaredField("attack");
		assertEquals("\"attack\" instance variable in class BattleEvent should not be accessed outside that class", 2,
				f.getModifiers());

		f = BattleEvent.class.getDeclaredField("collectible");
		assertEquals("\"collectible\" instance variable in class BattleEvent should not be accessed outside that class",
				2, f.getModifiers());
	}
	...
	public void testBattleEventClassREADVariables() throws Exception {
		...
		assertTrue("The \"type\" instance variable in class BattleEvent is a READ variable.",
				containsMethodName(methods, "getType"));

		assertTrue("The \"currentOpponent\" instance variable in class BattleEvent is a READ variable.",
				containsMethodName(methods, "getCurrentOpponent"));

		assertTrue("The \"winner\" instance variable in class BattleEvent is a READ variable.",
				containsMethodName(methods, "getWinner"));

		assertTrue("The \"attack\" instance variable in class BattleEvent is a READ variable.",
				containsMethodName(methods, "getAttack"));

		assertTrue("The \"collectible\" instance variable in class BattleEvent is a READ variable.",
	...
	public void testBattleEventClassWRITEVariables() throws Exception {
		Method[] methods = BattleEvent.class.getDeclaredMethods();
		assertFalse("The \"type\" instance variable in class BattleEvent is a READ ONLY variable.",
				containsMethodName(methods, "setType"));

		assertFalse("The \"currentOpponent\" instance variable in class BattleEvent is a READ ONLY variable.",
				containsMethodName(methods, "setCurrentOpponent"));

		assertFalse("The \"winner\" instance variable in class BattleEvent is a READ ONLY variable.",
				containsMethodName(methods, "setWinner"));

		assertFalse("The \"attack\" instance variable in class BattleEvent is a READ ONLY variable.",
				containsMethodName(methods, "setAttack"));

		assertFalse("The \"collectible\" instance variable in class BattleEvent is a READ ONLY variable.",
	...
	public void testDragonWishClassInstanceVariables() throws Exception {
		...
		assertEquals("\"senzuBeans\" instance variable in class DragonWish should be of type int", f.getType(),
				int.class);
		...
		assertEquals("\"abilityPoints\" instance variable in class DragonWish should be of type int", f.getType(),
				int.class);
		...
		assertEquals("\"superAttack\" instance variable in class DragonWish should be of type SuperAttack", f.getType(),
				SuperAttack.class);
	...
	public void testDragonWishClassVariablesAccessibility() throws Exception {
		...
		assertEquals("\"type\" instance variable in class DragonWish should not be accessed outside that class", 2,
				f.getModifiers());

		f = DragonWish.class.getDeclaredField("senzuBeans");
		assertEquals("\"senzuBeans\" instance variable in class DragonWish should not be accessed outside that class",
				2, f.getModifiers());

		f = DragonWish.class.getDeclaredField("abilityPoints");
		assertEquals(
				"\"abilityPoints\" instance variable in class DragonWish should not be accessed outside that class", 2,
				f.getModifiers());

		f = DragonWish.class.getDeclaredField("superAttack");
		assertEquals("\"superAttack\" instance variable in class DragonWish should not be accessed outside that class",
				2, f.getModifiers());

		f = DragonWish.class.getDeclaredField("ultimateAttack");
		assertEquals(
				"\"ultimateAttack\" instance variable in class DragonWish should not be accessed outside that class", 2,
				f.getModifiers());
	}
	...
	public void testGameClassConstructorInitialization() throws Exception {
		Game game = new Game();
		assertEquals(" The contructor of class Game should initialize the variable state to WORLD", GameState.WORLD,
				game.getState());
	}
	...
	public void testWorldClassConstructorInitialization() throws Exception {
		Game game = new Game();
		assertEquals("After creating a new game, the variable playerColumn should be initialized to be in column 9", 9,
				game.getWorld().getPlayerColumn());
		assertEquals("After creating a new game, the variable playerRow should be initialized to be in row 9", 9,
				game.getWorld().getPlayerRow());
	}
	...
	public void testBattleEventClassExtendsEventObject() throws Exception {
		assertEquals("BattleEvent class should extend EventObject", EventObject.class,
				BattleEvent.class.getSuperclass());
	}
	...
	public void testPlayerClassCallDragonMethodListeners() throws Exception {
		...
		p.callDragon();
		assertTrue("Player class should notify the Game class when a Dragon is called", hasCalled);
	}
	...
	public void testPlayerClassChooseWishMethodListeners() throws Exception {
		...
		Namekian n = new Namekian("namekian", 2, 100, 200, 300, 400, 500, 5, 6, 600, fightersSuperAttacks,
				fighterUltimateAttacks);
		...
		invokeSetter(p, PlayerListener.class, s);
		assertTrue("Player class should notify the Game class when a wish is chosen", hasCalled);
	}

	@Test(timeout = 1000)
	public void testPlayerClassHasListener() throws Exception {
		assertTrue("Player class should have an instance variable of type PlayerListener",
	...
	public void testListenersAreWriteVariables() throws Exception {
		Method[] methods = Player.class.getDeclaredMethods();
		int index = classContainsFieldAtIndex(Player.class, PlayerListener.class);
		if (index != -1) {
			Field f = Player.class.getDeclaredFields()[index];
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			assertTrue("The \"listener\" instance variable in class Player is a Write variable.",
		...
		if (index != -1) {
			...
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			assertTrue("The \"listener\" instance variable in class Cell is a Write variable.",
					containsMethodName(methods, methodName));
		}
		...
		if (index != -1) {
			...
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			assertTrue("The \"listener\" instance variable in class Battle is a Write variable.",
					containsMethodName(methods, methodName));
		}
		...
		if (index != -1) {
			...
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			assertTrue("The \"listener\" instance variable in class World is a Write variable.",
					containsMethodName(methods, methodName));
		}
		...
		if (index != -1) {
			...
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			assertTrue("The \"listener\" instance variable in class Game is a Write variable.",
					containsMethodName(methods, methodName));
		}
	}
	...
	public void testGameClassOnBattleEventMethodListeners() throws Exception {
		...
		Battle b = new Battle(new Saiyan("saiyan"), new NonPlayableFighter("foe", 1, 1, 1, 1, 1, 1, true, null, null));
		BattleEvent be = new BattleEvent(b, BattleEventType.ATTACK);
		Game g = new Game();
		g.onBattleEvent(be);
		invokeSetter(g, GameListener.class, s);
		g.onBattleEvent(be);
		assertTrue("Game class should notify the GameListener on BattleEvent", hasCalled);
		assertEquals("The Battle Event type notified from GameListener from the Game class is incorrect",
	...
	public void testGameClassOnDragonCalledMethodListeners() throws Exception {
		...
		invokeSetter(g, GameListener.class, s);
		g.onDragonCalled();
		assertTrue("Game class should notify the GameListener when a dragon is chosen", hasCalled);
	}

	@Test(timeout = 1000)
	public void testGameClassOnCollectibleFoundMethodListeners() throws Exception {
		hasCalled = false;
		GameController s = new GameController() {
		...
		assertTrue("Game class should notify the GameListener when a collectible is found", hasCalled);
	}

	@Test(timeout = 1000)
	public void testGameClassHasListener() throws Exception {
		assertTrue("Game class should have an instance variable of type GameListener",
				classContainsField(Game.class, GameListener.class));
	}

	@Test(timeout = 1000)
	public void testWorldClassHasListener() throws Exception {
		assertTrue("World class should have an instance variable of type WorldListener",
				classContainsField(World.class, WorldListener.class));
	}

	@Test(timeout = 1000)
	public void testCellClassHasListener() throws Exception {
		assertTrue("Cell class should have an instance variable of type CellListener",
				classContainsField(Cell.class, CellListener.class));
	}

	@Test(timeout = 1000)
	public void testBattleClassHasListener() throws Exception {
		assertTrue("Battle class should have an instance variable of type BattleListener",
	...
	public void testSuperAssignAttackMethod() throws Exception {
		...
		assertTrue(
				"assignAttack method in class Player should add the new super Attack to the list of superAttacks of the input fighter",
				player.getFighters().get(0).getSuperAttacks().contains(superAttack));
		assertFalse(
				"assignAttack method in class Player should remove the old super attack from the list of superAttacks of the input fighter",
				player.getFighters().get(0).getSuperAttacks().contains(s1));
		...
		assertFalse(
				"assignAttack method in class Player should not add the new super if the list of ultimate attacks of the input fighter is full",
				player.getFighters().get(1).getSuperAttacks().contains(superAttack));
	...
	public void testCreateFighterMethod() throws Exception {
		...
		assertEquals(
				"createFighter method in class Player should add the corresponding new fighter in the list of fighters",
		...
		assertEquals(
				"After creating a fighter, it should be set as the active fighter if it is the first fighter for the player",
		...
		assertEquals(
				"A newly created fighter should be set as the active fighter only if it is the first fighter for the player",
	...
	public void testSetKiMethodBoundaries() throws Exception {
		PlayableFighter fighter = new Earthling("Goku", 1, 1, 1, 1, 1, 1, 1, 5, 1, null, null);
		fighter.setKi(4);
		assertEquals("The ki should be correctly set according to the input of method setKi", 4, fighter.getKi());

		fighter.setKi(10);
		assertEquals("The ki cannot be set to a number that exceeds maxKi", fighter.getMaxKi(), fighter.getKi());

		fighter.setKi(-1);
		assertEquals("The ki cannot be set to a number that is less than 0", 0, fighter.getKi());
	}

	@Test(timeout = 1000)
	public void testSetXpMethod() throws Exception {
		PlayableFighter fighter = new Earthling("Goku", 1, 1, 100, 1, 1, 1, 1, 5, 1, null, null);
		fighter.setXp(10);
		assertEquals("The xp should be correctly set according to the corresponding input in method setXp", 10,
				fighter.getXp());

		fighter.setXp(100);
		assertEquals("Any fighter should level up once the xp reaches targetXp", 2, fighter.getLevel());
		assertEquals("The ability points of a fighter should increase by 2 on leveling up", 3,
				fighter.getAbilityPoints());
		assertEquals("The target xp of a fighter should increase by 20 on leveling up", 120, fighter.getTargetXp());
		assertEquals("The xp should be reset to zero after the fighter levels up", 0, fighter.getXp());

		fighter = new Earthling("Goku", 1, 1, 100, 1, 1, 1, 1, 5, 1, null, null);
		fighter.setXp(360);
		assertEquals("Any fighter should keep level up as long as his xp is more than the new targetXp", 4,
				fighter.getLevel());
		assertEquals("The ability points of a fighter should increase by 2 on each level up", 7,
				fighter.getAbilityPoints());
		assertEquals("The target xp of a fighter should increase by 20 on each level up", 160, fighter.getTargetXp());
		assertEquals("The xp should be reset to zero after the fighter levels up", 0, fighter.getXp());
	}

	@Test(timeout = 1000)
	public void testChooseWishMethod() throws Exception {
		PlayableFighter activeFighter = new Earthling("Goku", 1, 1, 1, 1, 1, 1, 1, 1, 1, null, null);
		Player player = new Player("player", new ArrayList<PlayableFighter>(), new ArrayList<SuperAttack>(),
				new ArrayList<UltimateAttack>(), 1, 1, activeFighter, 1);
		...
		assertEquals(
				"chooseWish method in class Player should increase the ability points "
		...
		player.chooseWish(wish);
		assertEquals(
				"chooseWish method in class Player should increase the senzubeans "
	...
	public void testOnAttackerTurn_OnDefenderTurnMethods_Saiyan_Majin() throws Exception {
		...
		assertEquals("OnAttackerTurn should not affect any attributes other than the stamina for a majin fighter", 0,
				majin.getKi());
		assertEquals("OnAttackerTurn should not affect any attributes other than the stamina for a majin fighter", 1500,
				majin.getHealthPoints());

		majin.onDefenderTurn();
		assertEquals("OnDefenderTurn should add one stamina for a majin fighter", 1, majin.getStamina());
		assertEquals("OnDefenderTurn should not affect any attributes other than the stamina for a majin fighter", 0,
				majin.getKi());
		assertEquals("OnDefenderTurn should not affect any attributes other than the stamina for a majin fighter", 1500,
				majin.getHealthPoints());
		...
		saiyan.setKi(2);
		saiyan.onAttackerTurn();
		assertEquals("OnAttackerTurn should decrease one ki bar from a saiyan fighter as long as he is transformed", 1,
				saiyan.getKi());
		saiyan.onDefenderTurn();
		assertEquals("OnDefenderTurn should decrease one ki bar from a saiyan fighter as long as he is transformed", 0,
				saiyan.getKi());
		assertFalse("A transformed saiyan should no longer be transformed once his Ki bars reach zero",
				saiyan.isTransformed());
		assertEquals("A transformed saiyan should have Stamina equal to zero once his Ki bars reach zero", 0,
				saiyan.getStamina());
	}
	...
	public void testMoveDown() throws Exception {
		...
		assertEquals("moveDown method in class World should move the player one cell down if possible",
				oldPlayerRow + 1, newPlayerRow);

		g.getWorld().moveDown();
		int playerRow = g.getWorld().getPlayerRow();
		assertEquals("moveDown method in class World should handle out of boundaries", playerRow, 9);
	...
	public void testMoveLeft() throws Exception {
		...
		assertEquals("moveLeft method in class World should move the player one cell to the left if possible",
				oldPlayerColumn - 1, newPlayerColumn);

		g.getWorld().moveLeft();
		int playerColumn = g.getWorld().getPlayerColumn();
		assertEquals("moveLeft method in class World should handle out of boundaries", playerColumn, 0);
	}
	...
	public void testOnDragonCalledGame() throws Exception {
		...
		for (int i = 0; i < dragons.size() - 1; i++)
			if (!dragons.get(i).getName().equals(dragons.get(i + 1).getName()))
				random = true;
	...
	public void testOnWinScenarioFighterDefeatsBoss() throws Exception {
		...
		Namekian n = new Namekian("namekian", 2, 100, 500, 300, 400, 500, 5, 6, 600, fightersSuperAttacks,
				fighterUltimateAttacks);
		ArrayList<PlayableFighter> fighters = new ArrayList<PlayableFighter>();
		fighters.add(n);
		p.setFighters(fighters);
		...
		assertFalse("On winning, the winner shouldn't gain a super attack that he already has",
				containDuplicatesSuperAttacks(p.getSuperAttacks()));

		assertFalse("On winning, the winner shouldn't gain an ultimate attack that he already has",
		...
		assertTrue("On winning, the fighter should gain the foe's super attacks",
				superAttacksListsAreEqual(p.getSuperAttacks(), newPlayerSuperAttacks));
		...
		assertTrue("On winning, the fighter should gain the foe's ultimate attacks",
				ultimateAttacksListsAreEqual(p.getUltimateAttacks(), newPlayerUltimateAttacks));
		...
		assertEquals("On winning a boss, the player's explored maps should be incremented by one", oldExploredMaps + 1,
				g.getPlayer().getExploredMaps());

		assertTrue("On winning a boss, a new world should be generated",
				TwoMapsDifferent(oldWorld.getMap(), g.getWorld().getMap()));

		assertEquals("Game State should be changed to WORLD when a battle ends", GameState.WORLD, g.getState());
	}

	@Test(timeout = 1000)
	public void testOnCollectibleFoundUponCollectingSevenDragonBalls() throws Exception {
		Game g = new Game();
		World w = g.getWorld();
		hasCalled = false;
		...
		if (i != -1) {
			...
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			Method setter = Cell.class.getMethod(methodName, CellListener.class);
			try {
				setter.invoke(w.getMap()[8][9], w);
			} catch (Exception e) {
				fail("The class: " + w.getMap()[8][9].getClass() + " should have a setter method for the listener");
			}
		}

		g.getPlayer().setDragonBalls(6);
		w.moveUp();
		assertTrue("Game class should call callDragon() method in Player class upon collecting 7 dragon balls",
				hasCalled);
	...
	public void testOnCollectibleFoundTurnsTheCellToAnEmptyCell() throws Exception {
		...
		w.moveUp();
		assertEquals("On collecting a dragon ball, the old collectible cell should be turned to an empty cell",
				EmptyCell.class, w.getMap()[8][9].getClass());
		...
		w.moveUp();
		assertEquals("On collecting a senzu bean, the old collectible cell should be turned to an empty cell",
				EmptyCell.class, w.getMap()[8][9].getClass());
	}
	...
	public void testGameStateChangesToBattleOnMeetingAFoe() throws Exception {
		...
		NonPlayableFighter foe = new NonPlayableFighter("Goku", 10, 3000, 350, 400, 5, 6, false, foeSuperAttacks,
				foeUltimateAttacks);
		...
		p.setActiveFighter(n);
		w.moveUp();
		assertEquals("Game state should be changed to BATTLE on meeting a foe", GameState.BATTLE, g.getState());
	...
	public void testBattleEventFirstConstructor() throws Exception {
		...
		boolean thrown = false;
		try {
			Constructor constructor = aClass.getConstructor(new Class[] { Battle.class, BattleEventType.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 2 parametesr in BattleEvent class.", thrown);
	}
	...
	public void testBattleEventSecondConstructor() throws Exception {
		...
		try {
			Constructor constructor = aClass
					.getConstructor(new Class[] { Battle.class, BattleEventType.class, BattleOpponent.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 3 parametesr in BattleEvent class.", thrown);
	}
	...
	public void testBattleEventThirdConstructor() throws Exception {
		...
		try {
			Constructor constructor = aClass
					.getConstructor(new Class[] { Battle.class, BattleEventType.class, Attack.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 3 parametesr in BattleEvent class.", thrown);
	...
	public void testBattleEventFourthConstructor() throws Exception {
		...
		try {
			Constructor constructor = aClass
					.getConstructor(new Class[] { Battle.class, BattleEventType.class, Collectible.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 3 parametesr in Battle Event class.", thrown);
	}

	@Test(timeout = 1000)
	public void testBattleEventFirstConstructorInitialization() throws Exception {
		NonPlayableFighter strong = new NonPlayableFighter("Goku", 10, 3000, 350, 400, 5, 6, true, null, null);
		...
		assertEquals("The constructor of BattleEvent class should initialize the type instance variable correctly.",
	...
	public void testBattleEventSecondConstructorInitialization() throws Exception {
		...
		assertEquals("The constructor of BattleEvent class should initialize the winner instance variable correctly.",
				e, be.getWinner());
	}
	...
	public void testBattleEventThirdConstructorInitialization() throws Exception {
		...
		assertEquals("The constructor of BattleEvent class should initialize the type instance variable correctly.",
				BattleEventType.ATTACK, be.getType());
		assertEquals("The constructor of BattleEvent class should initialize the attack instance variable correctly.",
				s, be.getAttack());
	}
	...
	public void testBattleEventFourthConstructorInitialization() throws Exception {
		...
		Frieza e = new Frieza("frieza");
		Battle b = new Battle(e, strong);
		BattleEvent be = new BattleEvent(b, BattleEventType.USE, Collectible.SENZU_BEAN);
		assertEquals("", Battle.class, ((Battle) (be.getSource())).getClass());
	...
	public void testDragonWishFirstConstructor() throws Exception {
		...
		boolean thrown = false;
		try {
			Constructor constructor = aClass.getConstructor(new Class[] { Dragon.class, DragonWishType.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 2 parametesr in DragonWish class.", thrown);
	}
	...
	public void testDragonWishSecondConstructor() throws Exception {
		...
		try {
			Constructor constructor = aClass
					.getConstructor(new Class[] { Dragon.class, DragonWishType.class, int.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 3 parametesr in DragonWish class.", thrown);
	}
	...
	public void testDragonWishThirdConstructor() throws Exception {
		...
		try {
			Constructor constructor = aClass
					.getConstructor(new Class[] { Dragon.class, DragonWishType.class, SuperAttack.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 3 parametesr in DragonWish class.", thrown);
	...
	public void testDragonWishFourthConstructor() throws Exception {
		...
		try {
			Constructor constructor = aClass
					.getConstructor(new Class[] { Dragon.class, DragonWishType.class, UltimateAttack.class });
		} catch (NoSuchMethodException e) {
			thrown = true;
		}
		assertFalse("Missing constructor with 3 parametesr in DragonWish class.", thrown);
	...
	public void testDragonWishSecondConstructorInitialization() throws Exception {
		...
		assertEquals("The constructor of DragonWish class should initialize the type instance variable correctly.",
		...
		assertEquals(
				"The constructor of DragonWish class that initializes the abilityPoints should not change the senzu beans.",
				0, dw.getSenzuBeans());
	}
	...
	public void testDragonWishSecondConstructorInitialization2() throws Exception {
		...
		assertEquals(
				"The constructor of BattleEvent class should initialize the senzuBeans instance variable correctly.", 3,
				dw.getSenzuBeans());
		assertEquals(
				"The constructor of DragonWish class that initializes senzu beans should not change the ability points.",
	...
	public void testDragonWishThirdConstructorInitialization() throws Exception {
		...
		boolean ok = dw.getSuperAttack().getDamage() == s.getDamage()
				&& dw.getSuperAttack().getName().equals(s.getName());
		assertTrue("The constructor of DragonWish class should initialize the superAttack instance variable correctly.",
				ok);
	}
	...
	public void testDragonWishFourthConstructorInitialization() throws Exception {
		...
		boolean ok = dw.getUltimateAttack().getDamage() == u.getDamage()
				&& dw.getUltimateAttack().getName().equals(u.getName());
		assertTrue("The constructor of DragonWish class should initialize the superAttack instance variable correctly.",
				ok);
	}
	...
	public void testBattleOpponentMethods() throws Exception {
		...
		try {
			...
			assertEquals("onAttackerTurn method in BattleOpponent interface does not return anything ", void.class,
					m.getReturnType());
		...
		try {
			...
			assertEquals("onFedenderTurn method in BattleOpponent interface does not return anything ", void.class,
					m.getReturnType());
	...
	public void testWorldClassAdditionalMethods() throws Exception {
		...
		try {
			...
			assertEquals("resetPlayerPosition method in World class does not return anything ", void.class,
					m.getReturnType());
		...
		try {
			...
			assertEquals("moveUp method in World class does not return anything ", void.class, m.getReturnType());
		...
		try {
			...
			assertEquals("moveDown method in World class does not return anything", void.class, m.getReturnType());
		...
		try {
			m = World.class.getDeclaredMethod("moveDown");
			assertEquals("moveLeft method in World class does not return anything ", void.class, m.getReturnType());
		...
		try {
			...
			assertEquals("moveRight method in World class does not return anything ", void.class, m.getReturnType());
	...
	public void testCellAndSubclassesAdditionalMethods() throws Exception {
		...
		try {
			...
			assertEquals("onStep method in Cell class does not return anything ", void.class, m.getReturnType());
			assertTrue("onStep method in Cell class does not have any default implementation for its subclasses",
					Modifier.isAbstract(m.getModifiers()));
		...
		try {
			...
			assertEquals("onStep method in EmptyCell class does not return anything ", void.class, m.getReturnType());
		...
		try {
			...
			assertEquals("onStep method in CollectibleCell class does not return anything ", void.class,
					m.getReturnType());
		...
		try {
			...
			assertEquals("onStep method in FoeCell class does not return anything ", void.class, m.getReturnType());
	...
	public void testCollectibleAdditionalMethods() throws Exception {
		...
		try {
			...
			assertEquals("toString method in Collectible should return a string ", String.class, m.getReturnType());
	...
	public void testBattleClassRenamedVariables() throws Exception {
		...
		assertFalse("currentOpponent instance variable in Battle class should be renamed to attacker", found);
		try {
	...
	public void testBattleClassAdditionalVariablesAndMethods() throws Exception {
		...
		try {
			...
			assertEquals("getAttacker method in Battle class should return a value of type BattleOpponent ",
		...
		assertFalse("attacker instance variable in Battle class is READ ONLY variable", found);
		try {
			found = true;
		...
		assertFalse("there should not be an instance variable called currentOpponent in Battle class now.", found);
		try {
			m = Battle.class.getDeclaredMethod("getAssignedAttacks");
			assertEquals("getAssignedAttacks method in Battle class should return a value of type ArrayList<Attack> ",
		...
		try {
			...
			assertEquals("block method in Battle class should return nothing ", void.class, m.getReturnType());
		...
		try {
			...
			assertEquals("play method in Battle class should return nothing ", void.class, m.getReturnType());
		} catch (Exception e) {
			fail("Missing \"play\" method in Battle class which takes no input parameters");
		}
		try {
			m = Battle.class.getDeclaredMethod("start");
			assertEquals("start method in Battle class should return nothing ", void.class, m.getReturnType());
		} catch (Exception e) {
			fail("Missing \"start\" method in Battle class which takes no input parameters");
		}
		try {
			m = Battle.class.getDeclaredMethod("endTurn");
			assertEquals("endTurn method in Battle class should return nothing ", void.class, m.getReturnType());
		} catch (Exception e) {
		...
		try {
			...
			assertEquals("switchTurn method in Battle class should return nothing ", void.class, m.getReturnType());
		} catch (Exception e) {
		...
		try {
			...
			assertEquals("getDefender method in Battle class should return a value of type BattleOpponet ",
					BattleOpponent.class, m.getReturnType());
		} catch (NoSuchMethodException e) {
		...
		try {
			m = Battle.class.getDeclaredMethod("use", new Class[] { Player.class, Collectible.class });
			assertEquals("use method in Battle class should return nothing ", void.class, m.getReturnType());
		} catch (Exception e) {
			fail("Missing \"use\" method in Battle class which takes no input parameters");

		}
		try {
			m = Battle.class.getDeclaredMethod("attack", new Class[] { Attack.class });
			assertEquals("attack method in Battle class should return nothing ", void.class, m.getReturnType());
		} catch (Exception e) {
	...
	public void testAttackAndSubclassesAdditionalMethods() throws Exception {
		Method m;
		try {
			m = Attack.class.getDeclaredMethod("getAppliedDamage", new Class[] { BattleOpponent.class });
			assertEquals("getAppliedDamage method in Attack class should return a value of type int ", int.class,
					m.getReturnType());
			assertTrue(
		...
		try {
			m = Attack.class.getDeclaredMethod("onUse",
					new Class[] { BattleOpponent.class, BattleOpponent.class, boolean.class });
			assertEquals("onUse method in Attack class should return nothing ", void.class, m.getReturnType());
			assertFalse("onUse method in Attack class has some implementation that is common among all its subclaases",
					Modifier.isAbstract(m.getModifiers()));
		...
		try {
			m = PhysicalAttack.class.getDeclaredMethod("getAppliedDamage", new Class[] { BattleOpponent.class });
			assertEquals("getAppliedDamage method in PhysicalAttack class should return a value of type int ",
		...
		try {
			m = PhysicalAttack.class.getDeclaredMethod("onUse",
					new Class[] { BattleOpponent.class, BattleOpponent.class, boolean.class });
			assertEquals("onUse method in PhysicalAttack class should return nothing ", void.class, m.getReturnType());

		} catch (NoSuchMethodException | SecurityException e) {
			fail("The \"PhysicalAttack\" class should override onUse method .");
		}
		try {
			m = SuperAttack.class.getDeclaredMethod("getAppliedDamage", new Class[] { BattleOpponent.class });
			assertEquals("getAppliedDamage method in SuperlAttack class should return a value of type int ", int.class,
					m.getReturnType());
		...
		try {
			m = SuperAttack.class.getDeclaredMethod("onUse",
					new Class[] { BattleOpponent.class, BattleOpponent.class, boolean.class });
			assertEquals("onUse method in SuperAttack class should return nothing ", void.class, m.getReturnType());

		} catch (NoSuchMethodException | SecurityException e) {
			fail("The \"SuperAttack\" class should override onUse method .");
		}
		try {
			m = UltimateAttack.class.getDeclaredMethod("getAppliedDamage", new Class[] { BattleOpponent.class });
			assertEquals("getAppliedDamage method in UltimateAttack class should return a value of type int ",
					int.class, m.getReturnType());
		...
		try {
			m = UltimateAttack.class.getDeclaredMethod("onUse",
					new Class[] { BattleOpponent.class, BattleOpponent.class, boolean.class });
			assertEquals("onUse method in UltimateAttack class should return nothing ", void.class, m.getReturnType());
	...
	public void testGetAssignedAttacks() throws Exception {
		...
		while (i < res.size()) {
			...
			if (current instanceof PhysicalAttack) {
				p = true;
				res.remove(current);
			} else if (current instanceof SuperAttack && current.getName().equals("Kamehameha")
				...
				s2 = true;
				res.remove(current);
			} else if (current instanceof UltimateAttack && current.getName().equals("Super Kamehameha")
					&& current.getDamage() == 450) {
				u1 = true;
				res.remove(current);
			} else if (current instanceof UltimateAttack && current.getName().equals("Spirit Bomb")
	...
	public void testPhysicalAttackGenerateKi() throws Exception {
		...
		int before = e.getKi();
		b.attack(new PhysicalAttack());
		assertEquals("When me attacks the foe with physical attack , me's Ki should increase by 1", before + 1,
				e.getKi());
		before = strong.getKi();
		b.attack(new PhysicalAttack());
		assertEquals("When foe attacks me physical attack , foe's Ki should increase by 1", before + 1, strong.getKi());
	}

	@Test(timeout = 1000)
	public void testUltimateAttackConsumesKiCorrectly() throws Exception {
		NonPlayableFighter strong = new NonPlayableFighter("Goku", 10, 3000, 350, 100, 5, 6, true, null, null);
		ArrayList<UltimateAttack> ultimateAttacks = new ArrayList<UltimateAttack>();
		ultimateAttacks.add(new UltimateAttack("Spirit Bomb", 500));
		...
		assertEquals("When me attacks foe with Ultimate attack , me's ki should be reduced by 3", before - 3,
				e.getKi());
		before = strong.getKi();
		b.attack(strong.getUltimateAttacks().get(0));
		assertEquals("When foe attacks me with Ultimate attack , foe's Ki should be reduced by 3", before - 3,
				strong.getKi());
	}

	@Test(timeout = 1000)
	public void testBlockingSuperAttack() throws Exception {
		NonPlayableFighter strong = new NonPlayableFighter("Goku", 10, 3000, 350, 400, 5, 3, true, null, null);
		ArrayList<SuperAttack> superAttacks = new ArrayList<SuperAttack>();
		superAttacks.add(new SuperAttack("Kamehameha", 250));
		Frieza e = new Frieza("frieza");
		e.setSuperAttacks(superAttacks);
	...
	public void testUseSenzuBeans() throws Exception {
		...
		assertEquals("When the player uses a senzu bean , it restores the stamina of me to max", e.getMaxStamina(),
				e.getStamina());
		assertEquals("Using a senzu bean does not affect the max stamina", sbefore, e.getMaxStamina());
		assertEquals("When the player uses a senzu bean ,it restores the health points of me to max ",
		...
		assertEquals("When the player uses a senzu bean, the number of senzu beans he has should be reduced by one", 2,
				p.getSenzuBeans());
	}
	...
	public void testGetDefender() throws Exception {
		...
		assertEquals("getDefender method in Battle class doesn't return the correct fighting party", strong,
				b.getDefender());
		b.attack(new PhysicalAttack());
		assertEquals("getDefender method in Battle class doesn't return the correct fighting party", e,
				b.getDefender());
	}
	...
	public void testSaiyanDoesnotStartTransformed() throws Exception {
		...
		assertFalse("Any Saiyan starts the battle untransformed", s.isTransformed());
	}

	@Test(timeout = 10000)
	public void testPlayMethod() throws Exception {
		NonPlayableFighter strong = new NonPlayableFighter("Goku", 10, 3000, 100, 100, 5, 6, true, null, null);
		Frieza e = new Frieza("frieza");
		ArrayList<SuperAttack> superAttacks = new ArrayList<SuperAttack>();
		superAttacks.add(new SuperAttack("Kamehameha", 250));
	...
	public void testOnUseMethodOnPhysicalAttack() throws Exception {
		...
		assertEquals(
				"the functionality of onUse method of a physical attack is incorrect in case of defender not blocking",
				2875, strong.getHealthPoints());
		a.onUse(e, strong, true);
		assertEquals(
				"the functionality of onUse method of a physical attack is incorrect in case of defender is blocking",
				2875, strong.getHealthPoints());
		assertEquals(
				" When calling onUse method on a Physical Attack , it should generate one Ki for the one who used it ",
				2, e.getKi());
	}
	...
	public void testMaximumCharge() throws Exception {
		...
		assertEquals(
				"Maximum Charge fills the empty Ki bars only . If the empty Ki bars are less than three , it will fill them ",
				5, strong.getKi());
		assertEquals("Maximum Charge does not increase the maximum Ki if the left empty Ki bars are less than three ",
				5, strong.getMaxKi());
	...
	public void testAttackMethodEndsTurn() throws Exception {
		...
		b.attack(new PhysicalAttack());
		assertTrue("Attack method in Battle class should end the turn", hasCalled);
	}
	...
	public void testEndTurnMethodSwitchesTurn() throws Exception {
		...
		m.invoke(b);
		assertTrue("EndTurn method in Battle class should switch the turn", hasCalled);
	}
	...
	public void testCurrentAttackerIsMe() throws Exception {
		...
		assertEquals("The active fighter \"me\" in class Battle should be the first one to attack in any new battle",
				me, battle.getAttacker());
	}

	// **************************** Helper methods
	// ********************************//
	@SuppressWarnings("rawtypes")
	private static void invokeSetter(Object mainObject, Class variableClass, Object variableObject)
			throws NoSuchMethodException, SecurityException {

		int index = classContainsFieldAtIndex(mainObject.getClass(), variableClass);

		if (index != -1) {
			Field f = mainObject.getClass().getDeclaredFields()[index];
			String n = f.getName().toUpperCase();
			String methodName = "set" + n.charAt(0) + f.getName().substring(1);
			Method setter = mainObject.getClass().getMethod(methodName, variableClass);
			try {
				setter.invoke(mainObject, variableObject);
			} catch (Exception e) {
				fail("The class: " + mainObject.getClass() + " should have a setter method for the listener");
			}
		}
	}
	...
	private static boolean containDuplicatesSuperAttacks(ArrayList<SuperAttack> s1) {
		boolean dup = false;
	...
	private static boolean containDuplicatesUltimateAttacks(ArrayList<UltimateAttack> s1) {
		boolean dup = false;
		for (int i = 0; i < s1.size(); i++)
			for (int j = i + 1; j < s1.size(); j++)
				if (s1.get(i).getName().equals(s1.get(j).getName())) {
	...
	private static boolean superAttacksListsAreEqual(ArrayList<SuperAttack> s1, ArrayList<SuperAttack> s2) {
		boolean equals = true;
		for (int i = 0; i < s1.size(); i++)
	...
	private static boolean ultimateAttacksListsAreEqual(ArrayList<UltimateAttack> s1, ArrayList<UltimateAttack> s2) {
		boolean equals = true;
		for (int i = 0; i < s1.size(); i++)
			if (!s1.get(i).getName().equals(s2.get(i).getName())) {
				equals = false;
